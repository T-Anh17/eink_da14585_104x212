...
// Hàm trả về tên năm âm lịch (ví dụ: "Binh Ngo")
const char* LUNAR_GetYearName(const struct Lunar_Date *lunar) {
    static char year_name[32];
    uint8_t stem_idx = LUNAR_GetStem(lunar);
    uint8_t branch_idx = LUNAR_GetBranch(lunar);

    // Kết hợp Can + Chi
    sprintf(year_name, "%s %s", Lunar_StemString[stem_idx], Lunar_ZodiacString[branch_idx]);
    return year_name;
}
 ...
 */
// @formatter:off
static const uint8_t YearMonthBit[153] = {
    
};
