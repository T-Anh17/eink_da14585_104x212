...
typedef enum {
    ...
    DISPLAY_MODE_CLOCK = 3,             // Chế độ hiển thị đồng hồ kim (toàn màn hình)
    DISPLAY_MODE_IMAGE = 4,             // Chế độ hiển thị hình ảnh
    DISPLAY_MODE_FABRIC_RECORD = 5      // Chế độ thẻ kho / ghi chép xả vải
} display_mode_t;
