...
void draw_fabric_record_page(const fabric_record_t *record, bool force_redraw) {
  ...
  // ===== 1. TITLE =====
  EPD_DrawUTF8(5, 1, 0, "FABRIC RELAXING RECORD", EPD_ASCII_Font16, 0, BLACK,
               WHITE);
  ...
  EPD_DrawUTF8(5, y, 0, buf, EPD_ASCII_Font16, 0, BLACK, WHITE);
  y += line;
  ...
  EPD_DrawUTF8(120, y, 0, buf, EPD_ASCII_Font16, 0, BLACK, WHITE);
  y += line;
  ...
  // ===== 4. FOOTER =====
  EPD_DrawUTF8(90, 105, 0, record->note, EPD_ASCII_Font16, 0, BLACK, WHITE);
}
